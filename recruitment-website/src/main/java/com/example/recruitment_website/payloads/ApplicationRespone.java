...
public class ApplicationRespone {
    ...
    public ApplicationRespone() {
    }

    

    public ApplicationRespone(String id, LocalDate createdDate, String cvLink, EmployeeDTO employee, JobEntity job, Status status) {
        this.id = id;
